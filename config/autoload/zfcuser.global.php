...
$settings = [
     ...
     */
    'auth_adapters' => [100 => ZfcUser\Authentication\Adapter\Db::class],
...
//    ],
	 ...
	 */
    'user_login_widget_view_template' => 'dashboard/login',
...
return [
    ...
    'service_manager' => [
        'aliases' => [
            'zfcuser_zend_db_adapter' => $settings['zend_db_adapter'] ?? Zend\Db\Adapter\Adapter::class,
        ],
    ],
];
